...
public class ArrayQueue <E> extends AbstractQueue <E> {
    ...
    public boolean isEmpty(){  //Added the is empty method,
        return front==back;
    }
    ...
    public E poll() {
        if (isEmpty())
            return null;
        return data[front++]; //removed item statement. added increment.
    }
    ...
    public boolean offer(E item) { //Remained the same.
        if (item == null)
            return false;
