...
public class BellsPizzaSimulation {
    ...
    private final int CYCLISTS = 3; //Changeable signal variable. if one wanted more or less cyclists
    /**
    ...
    private double run (Queue<Pizza> queue, Scanner logFile) {
        ...
        int[] cyclistAvailableAt = new int[CYCLISTS];     // change the singular int value to a arraylist to hold a constant the time when the cyclist will next be available.
        ...
        while (logFile.hasNext()) {
            ...
            for (int i = 0; i < CYCLISTS; i++) {  //Added a for loop to cycle through cyclists to check if they are free.
